<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Emergency_details.aspx.cs" Inherits="hospital_management.Nurse_dashboard.Emergency_details" %>
            ...
            <hr/>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <asp:DropDownList ID="ddlPatientID" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlPatientID_SelectedIndexChanged">
                        </asp:DropDownList>
                    </div>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <asp:TextBox ID="txtArrivalTime" runat="server" CssClass="form-control" TextMode="DateTimeLocal"></asp:TextBox>
            ...
            <asp:GridView ID="gvEmergency" runat="server" CssClass="table table-bordered table-striped mt-3"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Patient Name">
                        ...
                        <EditItemTemplate>
                            <asp:DropDownList ID="ddlPatientNameEdit" runat="server" CssClass="form-control"></asp:DropDownList>
                        </EditItemTemplate>
                    </asp:TemplateField>
                    <%--  <asp:TemplateField HeaderText="Patient Name">
            <ItemTemplate>
            ...
            <EditItemTemplate>
                <asp:TextBox ID="txtPatientNameEdit" runat="server" CssClass="form-control" Text='<%# Bind("patientName") %>'></asp:TextBox>
                    ...
                    <asp:TemplateField HeaderText="Arrival Time">
                        <ItemTemplate>
                            <asp:Label ID="lblArrivalTime" runat="server" Text='<%# Eval("arrivalTime", "{0:yyyy-MM-dd HH:mm:ss}") %>'></asp:Label>
